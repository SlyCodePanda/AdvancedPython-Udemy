...
send_button = Button(window, text="Send", bg="green", font=font03, fg="white", command=send)
send_button.pack()

quit_button = Button(window, text="Quit", bg="green", font=font03, fg="white", command=on_closing)
quit_button.pack()
